...
def format_query(query: str, prefix: str = 'Instruct: Given a web search query, retrieve the most relevant passage that answer the query.\nQuery: ', post: str = '\nThe most relevant passage: ') -> str:
    return f'{prefix} {query.strip()}{post}'.strip()

def format_passage(text: str, title: str = '', prefix: str = 'Instruct: Given a retrieved passage, summarize the passage.\nPassage: ', post: str = '\nSummarization: ') -> str:
    return f'{prefix} {title.strip()} {text.strip()}{post}'.strip()
