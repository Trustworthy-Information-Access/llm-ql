...
# , position_ids= None, past_key_values= None, inputs_embeds= None, labels= None, output_summarize_ids= None,output_predict_ids = None, use_cache= None, output_attentions = None, output_hidden_states = None, return_dict = None, cache_position = None
    ...
    def encode_passage(self, psg, labels=None):
        raise NotImplementedError('EncoderModel is an abstract class')

    def encode_query(self, qry, labels=None):
        raise NotImplementedError('EncoderModel is an abstract class')
