...
class NewLlamaModel(LlamaModel):
    ...
    def forward(
            ...
            special_token_position: Optional[int] = 200
        ...
        causal_mask[:, :, special_token_position+1:, :special_token_position] = torch.finfo(inputs_embeds.dtype).min
        # print(causal_mask.tolist())
        # assert 1> 2
        # embed positions
